...
description: "Manche Gehirnzellen sind echte Spezialisten – und richten damit Schaden an, zumindest wenn sie auf jemanden treffen, der im schottischen Tweed gekleidet ist."
pubDate: 2011-10-04
section: graue-substanz
lang: de
slug: satte-spezialisten-ueberreizen-das-gehirn
readingTime: ≈ 9 Min. Lesezeit
eyebrowDot: grey-matter
standfirst: "Flackernde Lichtblitze bestimmter Form lassen spezialisierte Gehirnzellen maximal feuern; sie überreizen damit ein sowieso schon überempfindliches Netzwerk und können einen Migräneanfall auslösen."
---

![](./_satte-spezialisten-ueberreizen-das-gehirn-hiphop2orientationpreferemce.png)
...
![](./_satte-spezialisten-ueberreizen-das-gehirn-acolorbar.png)
...
![Pinwheel](./_satte-spezialisten-ueberreizen-das-gehirn-farbraumwindraedchen.png)

Jeder Kantendetektor ist für nur eine Orientierung zuständig und meldet diese Präferenz, wenn er sie „sieht“, durch erhöhtes Feuern von [Aktionspotentialen](http://de.wikipedia.org/wiki/Aktionspotential) weiter. Jede mögliche Orientierung einer Kante im Gesichtsfeld wird von diesen spezialisierten Gehirnzellen mit Hilfe ihres sogenannten rezeptiven Felds gemessen. Stimmt die Orientierung im rezeptiven Feld nicht mit ihrer Präferenz überein und steht gar senkrecht dazu, bleibt sie stumm wie ein trotziges Kind vor einem Teller Spinat.
...
![](./_satte-spezialisten-ueberreizen-das-gehirn-migraenetrigger.png)  
...
Von zentraler praktischer Bedeutung ist, was Shepherd in einer neueren Arbeit schreibt (Shepherd 2010) und den Lesern meines Blogs nur allzu bekannt ist (s. [hier](https://scilogs.spektrum.de/blogs/blog/graue-substanz/2011-05-20/migraeneprophylaxe-am-arbeitsplatz) und [hier](https://scilogs.spektrum.de/blogs/blog/graue-substanz/2011-06-01/visueller-stress)).
...
![](./_satte-spezialisten-ueberreizen-das-gehirn-flowerpinwheel.jpg)
...
2 Oder Schokomandeln. Wobei das trotzige Kind, das so gar keine Präferenz für Spinat hat, zwar stumm bleibt, sich aber nicht Tod stellt – Ausnahmen bestätigen hier die Regel. Ebenso können Kantendetektoren auch mal ab und zu feuern, wenn eine Kante vertikal zur ihrer  Präfernz auftaucht. Dieses Feuern ist die Grundaktivität, vergleichbar mit dem Atmen des Kindes, um im Bild zu bleiben. Das Bild ist übrigens nicht rein metaphorisch. Im Gehirn des Kindes mag es spezialisierte Zellen geben, die auf Gummibärchen und Schokomandeln präferiert antworten. Oder bei Erwachsenen auf [Jennifer Aniston](http://www.nature.com/news/2005/050620/full/news050620-7.html).
...
4 Diese Illusion ist selbst ein möglicher Migräne-Trigger, deswegen binde ich keinen Film hier ein. Für Wagemutige und nicht Betroffene siehe die Wikipedia-Seite [Motion Aftereffect](http://en.wikipedia.org/wiki/Motion_aftereffect).
