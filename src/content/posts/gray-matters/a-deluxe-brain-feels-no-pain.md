...
standfirst: 'In Berlin, a new Collaborative Research Centre Control of self-organizing nonlinear systems is set up. One focus will be on mathematical neuroscience. The goal is to understand the brain''s control mechanisms and how their failure leads to diseases. The precise language of mathematics offers the promise for better diagnostic and therapeutic techniques.'
---
...
![Philipp Hövel (acting managing director), Sabine Klapp (vice-coordinator), my brain (deluxe version), and Eckehard Schöll (coordinator of the CRC 910, from left to right)](./_sfb910.png)
